...
contract LSTCalculatorBaseTest is Test {
    ...
    function testDiscountShouldCalculateCorrectly() public {
        ...
        mockUsePriceAsDiscount(false); // just needs to be here for initialization
        initCalculator(1e18);
...
contract TestLSTCalculator is LSTCalculatorBase {
    ...
    function usePriceAsDiscount() public view override returns (bool) {
        // always mock the value
        return MockToken(lstTokenAddress).usePriceAsDiscount();
    }
}
