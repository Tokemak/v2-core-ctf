...
library LogExpMath {
    ...
    /// @notice This error is thrown when a variable or result is not within the acceptable bounds defined in the
    /// function.
    error OutOfBounds();
    ...
    /**
     * @dev Internal high precision (36 decimal places) natural logarithm (ln(x)) with signed 18 decimal fixed point
     * argument,
     * for x close to one.
     *
